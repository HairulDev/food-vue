<template>
  <div class="glassmorphism w-[200px] min-h-[330px] max-h-[400px] rounded overflow-hidden shadow-lg">
    ...
    <div class="px-6 py-2 flex items-center justify-between">
      <button @click="openDetailModal" class="bg-[#b5179e] text-white font-bold py-2 px-4 rounded">
        Detail
      </button>
      <button @click="addToCart" class="bg-[#915EFF] text-white font-bold py-2 px-6 rounded">
